...
def llm_pipeline():
    ...
    generate_output_task = bert_output_before_fine_tuning_op()
...
if __name__ == "__main__":
    ...
    #version_id=kfp_client.list_pipeline_versions(pipeline_id=pipeline_id).pipeline_versions[0].pipeline_version_id
    ...
    #run_response = kfp_client.run_pipeline(experiment_id=experiment_id, job_name=run_name, pipeline_id=pipeline_response.pipeline_id, version_id=version_id, params={})